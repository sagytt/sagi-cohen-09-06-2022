	...
	<div class="home">
		<div
			...
			:class="{
				show: showModal,
				fade: !showModal,
				'alert-success': modalSuccess,
				'alert-danger': modalError,
			}"
			role="alert"
			v-if="showModal"
		>
		...
		<div>
			<div class="top" v-if="forecasts[0]">
				<div style="display: flex">
					<img
						:src="'/assets/images/' + forecasts[0]['Day']['Icon'] + '-s.png'"
						width="150"
						height="90"
						alt=""
					/>
					<div>
						...
						<h4>
							...
							{{ forecasts[0]["Temperature"]["Maximum"]["Unit"] }}
						</h4>
					</div>
				</div>
				<div>
					<button type="button" class="btn" @click="toggleFavourite()">
						<i
